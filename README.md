...
This repository is an event schema registry for [task tracker application](https://github.com/yaorlov/task_tracker). The main functionality - sharing schemas across different services plus validating data for specific events.
...
```
gem "schema_registry", git: "https://github.com/yaorlov/task_tracker_schema_registry.git"
```
